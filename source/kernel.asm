...
[SEGMENT .data]
    strWelcomeMsg   db  "        Welcome to the ChamoOS", 0x00
	strPrompt		db	" Chamo > ", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	" ChamoOS", 0x00	;OS details
	...
	strHelpMsg3		db 	"     boot  for Reboot",0x00
        strHelpMsg4    		db      "     exit  for shutdown", 0x00
